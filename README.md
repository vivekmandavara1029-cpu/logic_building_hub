...
* *nesting automorphic number.cpp*: to find all the automorphic number of a given range ( upper and lower limit ).And An Automorphic Number is an integer whose square ends with the exact same digits as the number itself.
